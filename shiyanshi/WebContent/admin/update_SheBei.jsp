...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="updateSheBei.do">  
      ...
      <div  align="center">
        ...
        <div class="field">
          <input type="text" class="input w50" value="${sy.snum }" name="snum" />
          <div class="tips"></div>
        </div>
        </div>
        </div>
      ...
      <div  align="center">
        ...
        <option value="充足" ${sy.mstatus=='充足'?'selected':''}>充足</option>
        <option value="缺乏" ${sy.mstatus=='缺乏'?'selected':''}>缺乏</option>
        </select>
